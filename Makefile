# This Makefile is for the OddsCalc extension to perl.
#
...
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[OddsCalc]
#     EXE_FILES => [q[script/oddscalc_cgi.pl], q[script/oddscalc_create.pl], q[script/oddscalc_fastcgi.pl], q[script/oddscalc_server.pl], q[script/oddscalc_test.pl]]
#     LICENSE => q[perl]
#     NAME => q[OddsCalc]
#     NO_META => q[1]
...
#     TEST_REQUIRES => {  }
#     VERSION => q[0.01]
#     VERSION_FROM => q[lib/OddsCalc.pm]
...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/oddscalc_cgi.pl \
	script/oddscalc_create.pl \
	script/oddscalc_fastcgi.pl \
	script/oddscalc_server.pl \
	script/oddscalc_test.pl
MAN3PODS = lib/OddsCalc.pm \
	lib/OddsCalc/Controller/Root.pm
...
TO_INST_PM = lib/OddsCalc.pm \
	lib/OddsCalc/Controller/Root.pm

PM_TO_BLIB = lib/OddsCalc.pm \
	blib\lib\OddsCalc.pm \
	lib/OddsCalc/Controller/Root.pm \
	blib\lib\OddsCalc\Controller\Root.pm
...
OddsCalc.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"OddsCalc\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	lib/OddsCalc.pm \
	lib/OddsCalc/Controller/Root.pm \
	script/oddscalc_cgi.pl \
	script/oddscalc_create.pl \
	script/oddscalc_fastcgi.pl \
	script/oddscalc_server.pl \
	script/oddscalc_test.pl
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) -u \
	  script/oddscalc_cgi.pl $(INST_MAN1DIR)\oddscalc_cgi.pl.$(MAN1EXT) \
	  script/oddscalc_create.pl $(INST_MAN1DIR)\oddscalc_create.pl.$(MAN1EXT) \
	  script/oddscalc_fastcgi.pl $(INST_MAN1DIR)\oddscalc_fastcgi.pl.$(MAN1EXT) \
	  script/oddscalc_server.pl $(INST_MAN1DIR)\oddscalc_server.pl.$(MAN1EXT) \
	  script/oddscalc_test.pl $(INST_MAN1DIR)\oddscalc_test.pl.$(MAN1EXT) 
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/OddsCalc.pm $(INST_MAN3DIR)\OddsCalc.$(MAN3EXT) \
	  lib/OddsCalc/Controller/Root.pm $(INST_MAN3DIR)\OddsCalc.Controller.Root.$(MAN3EXT) 
...
EXE_FILES = script/oddscalc_cgi.pl script/oddscalc_create.pl script/oddscalc_fastcgi.pl script/oddscalc_server.pl script/oddscalc_test.pl

pure_all :: $(INST_SCRIPT)\oddscalc_fastcgi.pl $(INST_SCRIPT)\oddscalc_test.pl $(INST_SCRIPT)\oddscalc_server.pl $(INST_SCRIPT)\oddscalc_create.pl $(INST_SCRIPT)\oddscalc_cgi.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)\oddscalc_fastcgi.pl $(INST_SCRIPT)\oddscalc_test.pl \
	  $(INST_SCRIPT)\oddscalc_server.pl $(INST_SCRIPT)\oddscalc_create.pl \
	  $(INST_SCRIPT)\oddscalc_cgi.pl 

$(INST_SCRIPT)\oddscalc_fastcgi.pl : script/oddscalc_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\oddscalc_fastcgi.pl
	$(CP) script/oddscalc_fastcgi.pl $(INST_SCRIPT)\oddscalc_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)\oddscalc_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\oddscalc_fastcgi.pl

$(INST_SCRIPT)\oddscalc_test.pl : script/oddscalc_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\oddscalc_test.pl
	$(CP) script/oddscalc_test.pl $(INST_SCRIPT)\oddscalc_test.pl
	$(FIXIN) $(INST_SCRIPT)\oddscalc_test.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\oddscalc_test.pl

$(INST_SCRIPT)\oddscalc_server.pl : script/oddscalc_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\oddscalc_server.pl
	$(CP) script/oddscalc_server.pl $(INST_SCRIPT)\oddscalc_server.pl
	$(FIXIN) $(INST_SCRIPT)\oddscalc_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\oddscalc_server.pl

$(INST_SCRIPT)\oddscalc_create.pl : script/oddscalc_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\oddscalc_create.pl
	$(CP) script/oddscalc_create.pl $(INST_SCRIPT)\oddscalc_create.pl
	$(FIXIN) $(INST_SCRIPT)\oddscalc_create.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\oddscalc_create.pl

$(INST_SCRIPT)\oddscalc_cgi.pl : script/oddscalc_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\oddscalc_cgi.pl
	$(CP) script/oddscalc_cgi.pl $(INST_SCRIPT)\oddscalc_cgi.pl
	$(FIXIN) $(INST_SCRIPT)\oddscalc_cgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\oddscalc_cgi.pl
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/OddsCalc.pm blib\lib\OddsCalc.pm \
	  lib/OddsCalc/Controller/Root.pm blib\lib\OddsCalc\Controller\Root.pm 
